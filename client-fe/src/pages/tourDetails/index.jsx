...
function TourDetails() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      const dates =
        response?.tour?.tourDetail?.map((detail) => detail.dayStart) || [];
                ...
                <div className="tour-detail-booking">
                  <div className="border-shadow">
                    <div className="tour-price">
                      <div className="price">
                        <p>
                          {activeDetail?.adultPrice
                            ? activeDetail.adultPrice.toLocaleString("vi-VN")
                            : "Liên hệ"}{" "}
                          đ <span>/ Khách</span>
                        </p>
                      </div>
                      ...
                      <div className="tour-price-info-content">
                        <div className="item">
                          <div className="label">
                            <img src={Code} alt="" />
                            <p>
                              Mã tour: <span>{tourDetails?.tour?.code}</span>
                            </p>
                          </div>
                        </div>
                        <div className="item">
                        ...
                        <div className="item">
                          <div className="label">
                            ...
                            <p>
                              Ngày khởi hành:{" "}
                              <span>
                                {formatDateVN(activeDetail?.dayStart)}
                              </span>
                            </p>
                          </div>
                        </div>
                        ...
                        <div className="item">
                          <div className="label">
                            ...
                            <p>
                              Số chỗ còn{" "}
                              <span>{activeDetail?.stock ?? 0} chỗ</span>
                            </p>
                          </div>
                        </div>
                      </div>
